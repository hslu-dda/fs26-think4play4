...
!(function (t, i) {
  ...
  class i {
    ...
    setValue(t) {
      return (
        this.getValue() !== t && ((this.object[this.property] = t), this._callOnChange(), this.updateDisplay()),
        this
      );
    }
    updateDisplay() {
  ...
  const n = { isPrimitive: !0, match: (t) => "string" == typeof t, fromHexString: s, toHexString: s },
    l = {
      isPrimitive: !0,
    ...
    r = {
      ...
      toHexString: ([t, i, e], s = 1) => l.toHexString(((t * (s = 255 / s)) << 16) ^ ((i * s) << 8) ^ (e * s)),
    },
    o = {
      isPrimitive: !1,
      match: (t) => Object(t) === t,
      ...
      toHexString: ({ r: t, g: i, b: e }, s = 1) =>
        l.toHexString(((t * (s = 255 / s)) << 16) ^ ((i * s) << 8) ^ (e * s)),
    },
    a = [n, l, r, o];
  class h extends i {
    constructor(t, i, e, n) {
      ...
      (super(t, i, e, "color"),
        ...
        (this._format = ((l = this.initialValue), a.find((t) => t.match(l)))),
        (this._rgbScale = n),
  ...
  class c extends i {
    ...
    _initSlider() {
      ...
      const t = (t) => {
          ...
          let e =
            ((s = t), (n = i.left), (l = i.right), (r = this._min), (o = this._max), ((s - n) / (l - n)) * (o - r) + r);
          var s, n, l, r, o;
